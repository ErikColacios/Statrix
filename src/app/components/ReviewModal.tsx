...
export default function ReviewModal({ game_id, game_name, game_cover }: Props) {
    ...
    return (
        <div id="reviewForm" className="flex relative w-full h-[60vh] flex-col border border-gray-500 space-y-8 pl-10 pr-10 blur-none text-white rounded rounded-2xl bg-black/60 backdrop-blur-lg">
            {alert}
            ...
            <div className="flex pt-12">
                <img src={`https://images.igdb.com/igdb/image/upload/t_720p/${game_cover}.png`} alt="Videogame cover" className="w-36 md:w-48 rounded" />
                <div className="flex flex-col w-full ml-8">
                    <textarea id="reviewBody" className="w-full h-full bg-black border border-gray-500 focus:outline-none resize-none focus:border-green-500 p-2" maxLength={1000} placeholder="Your review"></textarea>
                    <LikeDislikeButtons />
                </div>
            </div>
            <div className="absolute right-10 bottom-10" onClick={()=> handleInsertReview()}>
