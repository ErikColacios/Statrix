...
export default async function gamePage({params}: {params: {listId:string, gameId:string}}) {
    ...
    return(
        ...
        <div style={{backgroundImage: `url(${imagen})`}} className="w-full 2xl:h-screen p-8 pt-24 lg:p-18 xl:p-24 text-white bg-center bg-cover relative blurImage" key={index} >
