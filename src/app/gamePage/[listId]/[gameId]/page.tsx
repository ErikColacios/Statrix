...
export default async function gamePage({params}: {params: {listId:string, gameId:string}}) {
    ...
    return(
        ...
        <div style={{backgroundImage: `url(${imagen})`}} className="w-full p-8 pt-24 lg:p-18 xl:p-24 text-white bg-center bg-cover relative blurImage" key={index} >
                        ...
                        <div className="flex flex-col lg:flex-row blur-none">
                            <div className="w-full sm:w-3/3 border flex flex-col relative">
                                ...
                                <div className='grid xl:grid-cols-2 2xl:grid-cols-3 border 2xl:absolute bottom-0'>
                                    {/* Screenshots */}
                                    <img src={item.screenshots ? `https://images.igdb.com/igdb/image/upload/t_720p/${item.screenshots[0].image_id}.png` : ""} className='h-full border'/>
                                    <img src={item.screenshots[1] ? `https://images.igdb.com/igdb/image/upload/t_720p/${item.screenshots[1].image_id}.png` : ""} className='h-full border'/>
                                    <img src={item.screenshots[2] ? `https://images.igdb.com/igdb/image/upload/t_720p/${item.screenshots[2].image_id}.png` : ""} className='h-full border'/>
                                </div>
                            </div>
