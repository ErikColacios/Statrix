                    ...
                    <div className="bg-black border w-full mt-8">
                            <div className="flex flex-col lg:flex-row" >
                                <div className="flex lg:flex-col border blur-none">
                                    ...
                                    <div className='flex items-center justify-center space-x-8 p-3'>
                                        ...
                                        <div className='flex items-center'>
                                            ...
                                            <p className='ml-2 text-gray-300'>23</p>
                                        </div>
                                        {/* Starred by x users */}
                                        <div className='flex items-center'>
                                ...
                                <div className="flex flex-col lg:flex-row blur-none">
                                    ...
                                    <div className="flex flex-col w-full lg:w-1/3 p-4 border">
                                        <p className='text-base'>Your status</p>
                                        <span className="bg-gray-400 w-full h-px mt-1 mb-2"></span>
                                        <div className='flex flex-col space-y-4'>
                                            <SelectScoreScroll score={userVideogame[0].score} videogame_id={item.id}/>
                                            <div className='flex'>
                                                <span className='text-xl mr-4'>Hours played </span>
