...
export default async function Profile() {
    ...
    return (
        <section className="flex flex-col md:flex-row space-y-12 md:space-x-12 w-full h-screen pt-24 p-6 md:p-12 text-white bg-[url('/staticImages/dark_bg.jpg')] bg-cover">
            <div className="flex flex-col md:w-1/3 shadow-lg bg-zinc-900/80 greenShadow">

                {/* DIV PROFILE IMAGE */}
                <div className="relative h-70 z-20">
                    <img src="/staticImages/eldenring.jpg" />
                    <div className="w-36 h-36 2xl:w-48 2xl:h-48 rounded-full overflow-hidden ml-6 absolute top-8 2xl:top-14">
                        <img src="/profileImages/riku.jpg" className="h-full w-full object-cover"/>
                    </div>
                </div>
                ...
                <div className="p-6 pt-16">
                    <div className="flex items-center relative">
                        ...
                        <button className="bg-black border border-[#00FF11] pl-10 p-2 pr-10 absolute right-0 hover:bg-[#00FF11] hover:text-black">EDIT PROFILE</button>
                    </div>
            ...
            <div className="flex flex-col md:w-2/3 p-12 shadow-lg bg-zinc-900/80 greenShadow">
                        Coming soon ...
            </div>
