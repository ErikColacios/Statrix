...
export default function LogIn() {
    ...
    return (
        <section className={`relative flex w-full h-screen bg-[url("/staticImages/nightcity.jpg")] bg-cover`}>
            ...
            <div className='flex items-center justify-center bg-black/60 w-full p-8 sm:w-4/5 xl:w-1/3 backdrop-blur-md'>
                <form className='flex flex-col bg-zinc-900 text-white border border-green-500 rounded-lg w-full md:w-96 p-8 pt-14 pb-14 text-base' action={formAction}>
                    <div className='mb-8'>
                    ...
                    <button className="mt-2 text-white rounded-lg bg-gradient-to-r from-green-400 to-lime-400 p-2 hover:from-green-500 hover:to-lime-600 transition duration-300">Log in</button>
                    <GoogleLogInButton />
