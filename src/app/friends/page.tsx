                            ...
                            <div key={index} className='relative flex items-center p-2 mb-4 h-16 space-x-4 border border-gray-600 bg-zinc-900 rounded-lg'>
                                ...
                                <div className='absolute right-5'>
                                    ...
                                    {userSearchMode === FriendshipStatus.ACCEPTED ?
                                        <>
                                            <button className='text-sm p-1 rounded rounded-full border border-gray-500 hover:border-green-500'
                                            ...
                                            <button className='ml-2 text-sm p-1 rounded rounded-full border border-gray-500 hover:border-red-500'
