        ...
        <>
            <Dialog.Root>
                <Dialog.Portal>
                    ...
                    <Dialog.Content onCloseAutoFocus={(e) => { e.preventDefault() }} className={isOwner ? `fixed p-2 w-full md:w-4/5 lg:w-3/5 2xl:w-3/6 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg shadow-xl 
                ...
                <div className="grid lg:grid-cols-2 gap-4 mt-3">
                    ...
                    {listContent.map((game: Game, index: number) => (
                        <div className="group relative rounded rounded-lg overflow-hidden md:text-lg border border-gray-500 bg-zinc-900 hover:bg-zinc-800 hover:border-green-500" key={index}>
