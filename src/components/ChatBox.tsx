...
export default function ChatBox({ messages }: any) {
    ...
    return (
        <div className="w-96 h-full" key={0}>
            ...
            <div className="w-full">
                <div className="relative flex">
                    ...
                    />
                    <button className="absolute right-0 h-full px-4 rounded-xl bg-gradient-to-r from-green-500 to-lime-500 hover:from-green-500 hover:to-lime-600 transition duration-300">
