...
export default function ReviewModal({ gameId, gameName, gameCover }: Props) {
    ...
    if (!userId) {
        ...
        return (
            <div className="relative w-full md:w-[50rem] h-[75vh] md:h-[65vh] flex flex-col border border-gray-500 space-y-8 px-4 md:px-10 blur-none text-white rounded-2xl bg-black/60 backdrop-blur-lg">
                {alert}
