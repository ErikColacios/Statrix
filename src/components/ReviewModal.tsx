    ...
    if (!userId) {
        return (
            <div className="relative flex flex-col justify-center items-center text-center w-80 sm:w-full h-96 p-2 border border-gray-500 space-y-6 md:px-10 blur-none text-white rounded-2xl bg-black/60 backdrop-blur-lg">
                ...
                <Link href="/login" className="sm:w-72 text-xl px-6 py-2 rounded-xl bg-linear-to-r from-green-500 to-lime-500 hover:from-green-500 hover:to-lime-600 transition duration-300">Start now!</Link>
            </div>
        )
    } else {
        return (
