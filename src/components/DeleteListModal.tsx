...
export default function DeleteListModal({list_id}:Props) {
    ...
    return (
        <div className="flex flex-col items-center justify-center text-center h-[45vh] border border-gray-600 space-y-4 px-4 md:px-10 blur-none text-white rounded-2xl bg-zinc-900/20 backdrop-blur-lg">
            ...
            <div className="flex space-x-8 mt-12">
                <button onClick={handleDeleteList} className="text-md sm:text-lg text-white px-6 py-3 rounded-xl bg-gradient-to-r from-green-500 to-lime-500 hover:from-green-500 hover:to-lime-600 transition duration-300">Delete</button>
                <Dialog.Close className="text-md sm:text-lg border-green-500 text-green-400 hover:bg-green-900/30 rounded-xl px-6 py-3">
                    Cancel
                </Dialog.Close>
            </div>
        </div>
