...
export default function DeleteListModal({listId}:Props) {
    ...
    return (
        <div className="flex flex-col items-center justify-center text-center h-full sm:h-[45vh] border border-gray-600 space-y-4 px-4 md:px-10 text-white sm:rounded-2xl bg-black/60 backdrop-blur-lg">
            <Dialog.Close className="mt-8 absolute top-10 sm:top-0 right-10 p-2 rounded-sm transition hover:bg-gray-800" >
