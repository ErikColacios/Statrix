...
export default function DeleteListModal({list_id}:Props) {
    ...
    return (
        <div className="flex flex-col items-center justify-center text-center h-[45vh] border border-gray-600 space-y-4 px-4 md:px-10 blur-none text-white rounded-2xl bg-black/60 backdrop-blur-lg">
