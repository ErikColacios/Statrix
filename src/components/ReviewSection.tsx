        ...
        <div className='pt-14 sm:pt-5'>
            ...
            <div className='bg-zinc-900 p-4'>
                {reviews?.map((r: any, index: number) => (
                    <div className={`flex flex-col overflow-scroll no-scrollbar space-y-2 h-42 p-4 mb-8 rounded-lg bg-black/50 shadow-lg border ${r.recommended ? "cardReviewGreen shadow-green-500/30 border-green-600" : "cardReviewRed shadow-rose-500/30 border-rose-700"}`} key={index}>
