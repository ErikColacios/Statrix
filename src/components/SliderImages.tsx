    ...
    return (
        <>
            <Swiper onSwiper={(swiper: any) => (swiperRef.current = swiper)} slidesPerView={1} breakpoints={{1024: {slidesPerView: 2}}} pagination={{ clickable: true }} className='relative mt-6'>
                ...
                <SwiperSlide><img src={screenshots ? `https://images.igdb.com/igdb/image/upload/t_720p/${screenshots[0].image_id}.png` : ""} className='xl:h-78 w-full' alt='Slide 1'/></SwiperSlide>
                <SwiperSlide><img src={screenshots ? `https://images.igdb.com/igdb/image/upload/t_720p/${screenshots[1].image_id}.png` : ""} className='xl:h-78 w-full' alt='Slide 2'/></SwiperSlide>
                <SwiperSlide><img src={screenshots ? `https://images.igdb.com/igdb/image/upload/t_720p/${screenshots[2].image_id}.png` : ""} className='xl:h-78 w-full' alt='Slide 3'/></SwiperSlide>
                <SwiperSlide><img src={screenshots ? `https://images.igdb.com/igdb/image/upload/t_720p/${screenshots[3].image_id}.png` : ""} className='xl:h-78 w-full' alt='Slide 4'/></SwiperSlide>
            </Swiper>
        </>
    )
}