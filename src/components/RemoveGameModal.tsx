...
export default function RemoveGameModal({ listId, gameId, gameName, gameBaseImage, handleRemoveGame }: any) {

    return (
        <div className="flex flex-col items-center justify-center h-[55vh] sm:h-[35vh] border border-gray-600 space-y-4 px-4 md:px-10 text-white rounded-2xl bg-black/60 backdrop-blur-lg">
            ...
            <div className="flex flex-col sm:flex-row space-x-8 items-center">
                ...
                <div>
                    ...
                    <div className="flex space-x-8 mt-6">
                        <Dialog.Close onClick={() => handleRemoveGame(listId, gameId)} className="text-md sm:text-lg border-green-500 text-green-400 hover:bg-green-900/30 rounded-xl px-6 py-3">Remove</Dialog.Close>
                        <Dialog.Close className="text-md sm:text-lg px-6 py-3 rounded-xl bg-gradient-to-r from-green-500 to-lime-500 hover:from-green-500 hover:to-lime-600 transition duration-300">
                            Cancel
                        </Dialog.Close>
                    </div>
                </div>
