                    ...
                    <div className="flex space-x-4 mt-2">
                        <div className="flex flex-col">
                            ...
                            <div className="flex space-x-2">
                                <button className="focus:bg-gradient-to-r from-teal-500 to-cyan-500 rounded border border-gray-400 px-2 py-1 transition hover:text-white hover:bg-zinc-800">{GameStatus.PLAYING}</button>
                                <button className="focus:bg-gradient-to-r from-green-500 to-lime-500 rounded border border-gray-400 px-2 py-1 transition hover:text-white hover:bg-zinc-800">{GameStatus.COMPLETED}</button>
                                <button className="focus:bg-gradient-to-r from-indigo-600 to-blue-500 rounded border border-gray-400 px-2 py-1 transition hover:text-white hover:bg-zinc-800">{GameStatus.ON_HOLD}</button>
                                <button className="focus:bg-gradient-to-r from-red-600 to-orange-700 rounded border border-gray-400 px-2 py-1 transition hover:text-white hover:bg-zinc-800">{GameStatus.DROPPED}</button>
                            </div>
                            {/* <select className='w-32 rounded bg-gray-800 border border-gray-700 outline-none focus:border-green-600 p-2' id={'status'} 
                                onChange={()=> userGameInfo[0] ? userGameInfo[0].status : GameStatus.PLAYING} >
