...
export default function EditListInfoModal({ listId }: { listId: string }) {
    ...
    async function saveChanges(e: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            await updateListInfo(listId, listName, listDescription, listVisibility)
            router.refresh()
    ...
    return (
        <div className="w-full h-[40rem] flex-col border border-gray-600 px-4 py-12 md:px-10 text-white rounded-2xl bg-black/60 backdrop-blur-lg">
            ...
            <form className="flex flex-col text-sm mt-8" onSubmit={saveChanges}>
                ...
                <fieldset className='flex flex-col space-y-1'>
                    ...
                    <div className='flex space-x-4 pt-6'>
                        ...
                        <input type="checkbox" name="listFeatured" id="listFeatured" className='accent-green-500' />
