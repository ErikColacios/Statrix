...
export default function EditListInfoModal({ listId }: { listId: string }) {
    ...
    return (
        <div className="w-full h-full sm:h-160 flex flex-col justify-center border border-gray-600 px-4 py-10 md:px-10 text-white sm:rounded-2xl bg-black/60 backdrop-blur-lg">
            <Dialog.Close className="absolute right-5 top-15 sm:right-10 sm:top-10 p-2 rounded-sm transition hover:bg-gray-800">
