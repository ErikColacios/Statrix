...
export default function DeleteGameModal({ listId, gameId, gameName, gameBaseImage, handleRemoveGame }: any) {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full sm:h-[60vh] sm:h-[35vh] border border-gray-600 space-y-4 px-4 md:px-10 text-white rounded-2xl bg-black/60 backdrop-blur-lg">
            ...
            <div className="flex flex-col items-center justify-center text-center sm:text-start sm:flex-row sm:space-x-8">
                <img src={gameBaseImage} className="w-36 h-48 sm:w-32 rounded-sm" alt={'Game cover'} />
