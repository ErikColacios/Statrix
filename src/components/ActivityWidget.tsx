    ...
    return (
        <div className="flex flex-col space-y-2">
            {userActivity.map((activity: Activity, index: number) => (
                <div className='w-full flex items-center space-x-8 py-1 pr-4 relative bg-zinc-900 border border-gray-600 overflow-hidden rounded-lg text-white text-sm sm:text-base' key={index}>
                    <div className={`absolute left-0 top-0 w-12 h-12 sm:w-14 sm:h-14`}>
