    ...
    return (
        <>
            <Swiper onSwiper={(swiper: any) => (swiperRef.current = swiper)} slidesPerView={1} pagination={{ clickable: true }} className='w-full rounded-2xl mt-6'>
                ...
                <SwiperSlide>
                    <div className='flex flex-col justify-center bg-gradient-to-b from-black via-gray-900 to-black px-12 py-8 h-full'>
                        <p className='text-green-400 mb-4'>Top played games</p>
                        <div className="flex ">
                ...
                <SwiperSlide>
                    <div className='flex flex-col justify-center bg-gradient-to-b from-black via-gray-900 to-black px-12 py-8 h-full'>
                        <p className='text-green-400 mb-4'>Favourite games</p>
                        <div className="flex ">
