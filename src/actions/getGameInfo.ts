...
export default function getGameInfo(gameId: number) {
  ...
  const res = fetch("https://api.igdb.com/v4/games", {
    ...
    body: `fields id, name, summary, rating, cover.image_id, release_dates.human, involved_companies.company.name, screenshots.image_id, genres.name, artworks.image_id;
